...
var Env = []extras.Triangle{
	{[]extras.Vector3{{X: 1, Y: 1, Z: 1}, {X: 1, Y: -1, Z: 1}, {X: -1, Y: -1, Z: 1}},
		color.RGBA{R: 150, G: 75, B: 255, A: 255}},
	{[]extras.Vector3{{X: -1, Y: -1, Z: 1}, {X: -1, Y: 1, Z: 1}, {X: 1, Y: 1, Z: 1}},
		color.RGBA{R: 150, G: 75, B: 255, A: 255}},
	{[]extras.Vector3{{X: 1, Y: 1, Z: 3}, {X: 1, Y: -1, Z: 3}, {X: -1, Y: -1, Z: 3}},
		color.RGBA{R: 150, G: 75, B: 255, A: 255}},
	{[]extras.Vector3{{X: -1, Y: -1, Z: 3}, {X: -1, Y: 1, Z: 3}, {X: 1, Y: 1, Z: 3}},
		color.RGBA{R: 150, G: 75, B: 255, A: 255}},
	{[]extras.Vector3{{X: -1, Y: -1, Z: 1}, {X: -1, Y: -1, Z: 3}, {X: -1, Y: 1, Z: 3}},
		color.RGBA{R: 150, G: 75, B: 255, A: 255}},
	{[]extras.Vector3{{X: -1, Y: 1, Z: 1}, {X: -1, Y: 1, Z: 3}, {X: -1, Y: -1, Z: 1}},
		color.RGBA{R: 150, G: 75, B: 255, A: 255}},
	{[]extras.Vector3{{X: 1, Y: 1, Z: 1}, {X: 1, Y: -1, Z: 1}, {X: 1, Y: -1, Z: 3}},
		color.RGBA{R: 150, G: 75, B: 255, A: 255}},
	{[]extras.Vector3{{X: 1, Y: -1, Z: 3}, {X: 1, Y: 1, Z: 3}, {X: 1, Y: 1, Z: 1}},
		color.RGBA{R: 150, G: 75, B: 255, A: 255}},
	{[]extras.Vector3{{X: -1, Y: 1, Z: 3}, {X: 1, Y: 1, Z: 3}, {X: -1, Y: 1, Z: 1}},
		color.RGBA{R: 150, G: 75, B: 255, A: 255}},
	{[]extras.Vector3{{X: -1, Y: 1, Z: 1}, {X: -1, Y: 1, Z: 1}, {X: -1, Y: 1, Z: 3}},
